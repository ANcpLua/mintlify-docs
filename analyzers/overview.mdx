...
| [AL0011](/analyzers/rules/AL0011) | Threading         | Avoid lock on non-Lock types                            | Warning  |  -  |
...
| [AL0014](/analyzers/rules/AL0014) | Style             | Prefer pattern matching for null/zero                   |   Info   | Yes |
...
| [AL0025](/analyzers/rules/AL0025) | Usage             | Anonymous function can be static                        |   Info   | Yes |
